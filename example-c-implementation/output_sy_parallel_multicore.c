...
void *loop0(void* arg)
{
	...
	WaitForSingleObject(mutex_s_out1, INFINITE);
...
void *loop1(void* arg)
{
	...
	// aquire mutex for both input and output signals
	WaitForSingleObject(mutex_s_out2, INFINITE);
...
void *loop2(void* arg)
{
	...
	// aquire mutex for both input and output signals
	WaitForSingleObject(mutex_s_out3, INFINITE);
...
void *loop3(void* arg)
{
	...
	// aquire mutex for both input and output signals
	WaitForSingleObject(mutex_s_out4, INFINITE);
...
// make mutexes for each signal
	...
	mutex_s_out1 = CreateMutex(NULL, TRUE, NULL);
	mutex_s_out2 = CreateMutex(NULL, TRUE, NULL);
	mutex_s_out3 = CreateMutex(NULL, TRUE, NULL);
	mutex_s_out4 = CreateMutex(NULL, TRUE, NULL);
